...
export function log(colorFn, label, message) {
  const displayedMessage = (typeof message === 'object') ? JSON.stringify(message) : message
  console.log(colorFn(`[${label.toUpperCase()}] ${displayedMessage}`))
}
